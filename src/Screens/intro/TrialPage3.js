                ...
                <section className="gradient-form" >
                    <div className='d-flex'>
                        <div className='col-md-2 text-left prevBtn' style={{ marginTop: '42vh' }}>
                            <a href="#/trialpage2" class="previous round" style={{ textDecoration: 'none', display: 'inline-block', fontSize: '150px', padding: '10px' }}>&#8249;</a>
                        </div>
                                ...
                                <div className="Question_page_left">
                                    ...
                                    <div className='row m-0 mt-3'>
                                        ...
                                        <div className='col-md-4 p-0 text-center'>
                                            <button className='trial-game-start-btn'>Bird Species Choices <span className='lognarrow-down text-white'>&#x2B07;</span></button>
                                        </div>
                                    </div>
                                    ...
                                    <div className='row mt-3'>
                                        <div className='col-md-12 form-outline text-center'>
                                            <button onClick={() => history.push('/trialpage4')} className="nextbtn btn-success" disabled>
                        ...
                        <div className='col-md-2 text-right nextBtn' style={{ marginTop: '42vh' }}>
                            <a href="#/trialpage4" class="next round" style={{ textDecoration: 'none', display: 'inline-block', fontSize: '150px', padding: '10px' }}>&#8250;</a>
                        </div>
                    </div>
                </section>
            </div>
