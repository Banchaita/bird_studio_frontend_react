                ...
                <section className="gradient-form" >
                    <div className='d-flex'>
                        <div className='col-md-2 text-left prevBtn' style={{ marginTop: '42vh' }}>
                            <a href="#/trialpage4" class="previous round" style={{ textDecoration: 'none', display: 'inline-block', fontSize: '150px', padding: '10px' }}>&#8249;</a>
                        </div>
                            ...
                            <div className="Question_page mt-3">
                                <div className="Question_page_left">
                                    <div className='row'>
                                        ...
                                        <div onClick={() => submit()} className='col-md-12 reductions  centertext-reduction text-center '>
                                    ...
                                    <div className='next_button_trail'>
                                        <div className='form-outline text-right btn-area'>
                                            <button onClick={() => history.push('/trialpage6')} style={{ width: "100px" }} className="nextbtn btn-success" disabled>
                                        ...
                                        <div className='col-md-4 form-outline text-center'>
                                            <button className='bottom-game-start-btn'><span className='lognarrow-left text-white'>&#x2B05;</span> Click here To use 50-50 </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className='col-md-2 text-right nextBtn' style={{ marginTop: '42vh' }}>
                            <a href="#/trialpage6" class="next round" style={{ textDecoration: 'none', display: 'inline-block', fontSize: '150px', padding: '10px' }}>&#8250;</a>
                        </div>
                    </div>
                </section>
            </div>
