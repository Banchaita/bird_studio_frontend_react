                ...
                <section className="gradient-form" >
                    <div className='d-flex'>
                        <div className='col-md-2 text-left prevBtn' style={{ marginTop: '42vh' }}>
                            <a href="#/trialpage1" class="previous round" style={{ textDecoration: 'none', display: 'none', fontSize: '150px', padding: '10px' }}>&#8249;</a>
                        </div>
                        <div className='col-md-8 text-center'>
                            <div className="Question_page">
                                <div className="Question_page_left">
                                    ...
                                    <div className='start_trail'>
                                        <div className='col-md-4 text-center mb-2'>
                                            <button className='game-start-btn'>Start Button <span className='lognarrow text-white'>&#x27A1;</span></button>
                                    ...
                                    <div className='row mt-5'>
                                        <div className='col-md-12 form-outline text-center'>
                                            <button onClick={() => history.push('/trialpage2')} className="nextbtn btn-success" disabled>
                                ...
                                <div className='Question_page_right check-box-area'>
                                    <p style={{ fontSize: "24px" }} className="mt-3 d-lg-none">Progress Bar</p>
                        ...
                        <div className='col-md-2 text-right nextBtn' style={{ marginTop: '42vh', }}>
                            <a href="#/trialpage2" class="next round" style={{ textDecoration: 'none', display: 'inline-block', fontSize: '150px', padding: '10px' }}>&#8250;</a>
                        </div>
                    </div>
                </section>
            </div>
