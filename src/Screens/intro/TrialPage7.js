                ...
                <section className="gradient-form" >
                    <div className='d-flex'>
                        <div className='col-md-2 text-left prevBtn' style={{ marginTop: '42vh' }}>
                            <a href="#/trialpage6" class="previous round" style={{ textDecoration: 'none', display: 'inline-block', fontSize: '150px', padding: '10px' }}>&#8249;</a>
                        </div>
                            ...
                            <div className="Question_page mt-3">
                                <div className="Question_page_left">
                                    ...
                                    <div className='row mt-3'>
                                        <div className='col-md-12 form-outline text-center'>
                                            <button onClick={() => history.push('/trialpage8')} className="nextbtn btn-success" disabled>
                                ...
                                <div className='Question_page_right check-box-area'>
                                    <div className='col-md-4 mt-2'>
                                        <button className='progress-game-start-btn'>Progress Bar <span className='left-lognarrow text-white'>&#x27A1;</span></button>
                                    </div>
                        ...
                        <div className='col-md-2 text-right nextBtn' style={{ marginTop: '42vh' }}>
                            <a href="#/trialpage8" class="next round" style={{ textDecoration: 'none', display: 'inline-block', fontSize: '150px', padding: '10px' }}>&#8250;</a>
                        </div>
                    </div>
                </section>
            </div>
