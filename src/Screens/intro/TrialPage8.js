                ...
                <section className="gradient-form" >
                    <div className='d-flex'>
                        <div className='col-md-2 text-left prevBtn' style={{ marginTop: '42vh' }}>
                            <a href="#/trialpage7" class="previous round" style={{ textDecoration: 'none', display: 'inline-block', fontSize: '150px', padding: '10px' }}>&#8249;</a>
                        </div>
                        <div className='col-md-8 text-center'>
                            <div className="Question_page mt-3">
                                <div className="Question_page_left">
                                    ...
                                    <div className='next_message_trail'>
                                        <div className='p-0 text-left marginBottom'>
                                            <button className='bottom-right-game-start-btn'>Click Next to Listen Next Song <span className='down-right-lognarrow text-white'>&#x27A1;</span></button>
                                        </div>
                                        <div className='p-0 text-left'>
                                            <button onClick={() => history.push('/trialquestion')} className="trial-nextbtn btn-success" disabled>
                                    ...
                                    <div className='row'>
                                        <div className='col-12 mt-3'>
                                            <a className='singuptext' style={{ fontSize: '20px', marginLeft: '33px' }} onClick={() => history.push('/trialquestion')}>Try a Sample Question Yourself! Click Here </a>
                                        </div>
                                    </div>
                                </div>
