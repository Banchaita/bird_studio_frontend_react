                ...
                <section className="gradient-form" >
                    <div className='d-flex'>
                        <div className='col-md-2 text-left prevBtn' style={{ marginTop: '42vh' }}>
                            <a href="#/trialpage5" class="previous round" style={{ textDecoration: 'none', display: 'inline-block', fontSize: '150px', padding: '10px' }}>&#8249;</a>
                        </div>
                            ...
                            <div className="Question_page mt-3">
                                <div className="Question_page_left">
                                    <div className='row'>
                                        ...
                                        <div className='col-md-12 reductions  centertext-reduction text-center '>
                                            <p>50-50 &nbsp;<span>1</span></p>
                                        </div>
                                    </div>
                                    ...
                                    <div className='row mt-3'>
                                        ...
                                        <div disabled={isNextActive} className='col-md-4 text-center trial-playbtn'>
                                            <img
                                        ...
                                        <div className='col-md-4 text-center mt-2'>
                                            <button className='gray-game-start-btn'>Incorrect Selections Are Grayed Out <span className='down-lognarrow text-white'>&#x2B07;</span></button>
                                        </div>
                                    </div>
                                    ...
                                    <div className='row mt-3'>
                                        <div className='col-md-12 form-outline text-center'>
                                            <button onClick={() => history.push('/trialpage7')} className="nextbtn btn-success" disabled>
                        ...
                        <div className='col-md-2 text-right nextBtn' style={{ marginTop: '42vh' }}>
                            <a href="#/trialpage7" class="next round" style={{ textDecoration: 'none', display: 'inline-block', fontSize: '150px', padding: '10px' }}>&#8250;</a>
                        </div>
                    </div>
                </section>
            </div>
